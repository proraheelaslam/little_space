              ...
              <form>
                <div>
                  <input type="text" id="txt_search" name="search_address" class="form-select1 form-select "
                    ...
                    <button style="position: relative;bottom: 79px;left:70px;" type="button" id="btn_search">
                      Search
                  </button>
                </div>
        ...
        <div class="container">
          <div class="backlink w-100 d-flex justify-content-between align-items-center px-3 px-md-0">
            <a href="#" class="mb-md-4">
              <svg width="20" height="32" viewBox="0 0 20 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.25 28.5L3.75 16L16.25 3.5" stroke="white" stroke-width="6.66667" stroke-linecap="round"
                  stroke-linejoin="round" />
              </svg>
            </a>
        ...
        <div class="container">
          <div class="row mx-0">
            <div class="col-lg-6 px-4 px-md-3">
              <h3>WHATS NEXT?</h3>
              <ul class="m-0 p-0">
                <li class="d-flex justify-content-start align-items-center"><span
                    class="d-flex justify-content-center align-items-center me-3">1</span> Receive your BANGS! by email
                </li>
                <li class="d-flex justify-content-start align-items-center"><span
                    class="d-flex justify-content-center align-items-center me-3">2</span>Call your local BANGS! HQ</li>
                <li class="d-flex justify-content-start align-items-center"><span
                    class="d-flex justify-content-center align-items-center me-3">3</span>Get your BANGS! price</li>
              </ul>
            </div>
            <div class="col-lg-6 formTabTwo">
              ...
              <div class="row text-start">
                ...
                <div class="col-lg-12">
                  <div class="nav MultiTab justify-content-center mx-auto" id="nav-tab" role="tablist">
                    <button class="form-btn border-0 w-100 mb-4 user_profile_step_button" id="nav-contact-tab"
                      data-bs-toggle="tab" type="button" role="tab" aria-controls="nav-contact"
                      aria-selected="false">Get my BANG</button>
                  </div>
                </div>
              </div>
            </div>
