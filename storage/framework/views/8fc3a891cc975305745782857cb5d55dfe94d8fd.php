    ...
    <div class="tab-pane fade show active" id="na-home" role="tabpanel" aria-labelledby="na-home-tab">
      ...
      <div class="centerSec">
        ...
        <div class="col-12 p-0 d-flex justify-content-between align-items-center d-md-none">
          <img class="pe-3" src="<?php echo e(asset('frontend/images/img11.png')); ?>" width="150" alt="" />
        ...
        <div class="container">
          <div class="row mx-0 bg-draft">
            <div class="col-lg-5 col-12 px-0">
              ...
              <form>
                ...
                <div class="textareaSec position-relative">
                  <div class="d-flex">
                    <img src="<?php echo e(asset('frontend/images/img10.png')); ?>" alt="" width="35" height="35"
            ...
            <div class="col-lg-7 d-none d-md-flex flex-column">
              <img class="bang_type_image" src="<?php echo e(asset('frontend/images/img11.png')); ?>" class="w-100" alt="" />
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="w-210 position-relative">
                ...
                <img src="<?php echo e(asset('frontend/images/img10.png')); ?>" alt="" width="35" height="35" class="position-absolute top-0 end-0">
              </div>
            </div>
            <div class="col-md-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\bangs_2\resources\views/frontend/pages/home/home.blade.php ENDPATH**/ ?>